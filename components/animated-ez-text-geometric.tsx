...
interface AnimatedEZTextGeometricProps {
  className?: string
}

export default function AnimatedEZTextGeometric({ className = "" }: AnimatedEZTextGeometricProps) {
  ...
  return (
    <div className={`relative inline-block ${className}`}>
      ...
      {/* SVG for drawing animation with clean geometric lines */}
      <div className="absolute inset-0 flex items-center justify-center z-10">
        ...
        >
          {/* E letter with clean geometric lines */}
          ...
          {/* Z letter with clean geometric lines */}

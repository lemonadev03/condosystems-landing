...
interface AnimatedEZTextAngularProps {
  className?: string
}

export default function AnimatedEZTextAngular({ className = "" }: AnimatedEZTextAngularProps) {
  ...
  return (
    <div className={`relative inline-block ${className}`}>
      {/* Highlighter background with angular edges */}
      <motion.div
        className="absolute inset-0 bg-[#407140]/25 z-0"
        style={{
          clipPath: "polygon(1% 8%, 99% 0%, 100% 92%, 0% 100%)",
      ...
      {/* SVG for drawing animation with straight lines and angular corners */}
      <div className="absolute inset-0 flex items-center justify-center z-10">
        ...
        >
          {/* E letter with straight lines and angular corners */}
          {/* Top horizontal line of E */}
          <motion.path
            d="M15,20 L17,18 L78,18 L82,22"
            stroke="#407140"
            strokeWidth="18"
            strokeLinecap="butt"
          ...
          <motion.path
            d="M15,100 L17,102 L78,102 L82,98"
            stroke="#407140"
            strokeWidth="18"
            strokeLinecap="butt"
            strokeLinejoin="miter"
          ...
          {/* Vertical line of E */}
          <motion.path
            d="M15,20 L13,22 L13,98 L15,100"
            stroke="#407140"
            strokeWidth="18"
            strokeLinecap="butt"
            strokeLinejoin="miter"
          ...
          {/* Z letter with straight lines and angular corners */}
          {/* Top horizontal line of Z */}
          <motion.path
            d="M110,20 L112,18 L170,18 L174,22"
            stroke="#407140"
            strokeWidth="18"
            strokeLinecap="butt"
            strokeLinejoin="miter"
          ...
          <motion.path
            d="M110,100 L112,102 L170,102 L174,98"
            stroke="#407140"
            strokeWidth="18"
            strokeLinecap="butt"
            strokeLinejoin="miter"
          ...
          {/* Diagonal line of Z */}
          <motion.path
            d="M174,22 L172,18 L112,98 L110,102"
            stroke="#407140"
            strokeWidth="18"
            strokeLinecap="butt"
            strokeLinejoin="miter"

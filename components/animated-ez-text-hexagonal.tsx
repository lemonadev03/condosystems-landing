...
interface AnimatedEZTextHexagonalProps {
  className?: string
}

export default function AnimatedEZTextHexagonal({ className = "" }: AnimatedEZTextHexagonalProps) {
    ...
    <div className={`relative inline-block ${className}`}>
      ...
      <div className="absolute inset-0 flex items-center justify-center z-10">
        ...
        >
          ...
          {/* Z letter as a proper hexagonal shape */}
          {/* Instead of separate lines, we'll use a single path for the Z */}
          <motion.path

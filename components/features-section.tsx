        ...
        {features.map((feature, index) => {
          ...
          return (
            ...
            >
              ...
              >
                <div className="relative rounded-2xl bg-gradient-to-br from-azure-100 to-azure-200 p-8 md:p-12 shadow-lg overflow-hidden">
                  {/* Placeholder for screenshot - you'll replace this with actual images */}
                  <div className="aspect-[4/3] bg-white/80 backdrop-blur-sm rounded-lg shadow-inner flex items-center justify-center">
                  ...
                  {/* Decorative elements */}
                  <div className="absolute top-4 right-4 w-20 h-20 bg-azure-300/30 rounded-full blur-2xl"></div>
                  <div className="absolute bottom-4 left-4 w-32 h-32 bg-azure-400/20 rounded-full blur-3xl"></div>
                </div>
              </div>

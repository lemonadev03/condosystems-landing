...
export default function ValueSection({ onMouseEnter, onMouseLeave, valueInViewRef }: ValueSectionProps) {
  return (
    <ParallaxSection id="value" ref={valueInViewRef} className="py-20 md:py-32 bg-white">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          >
            We've reimagined the real estate affiliate experience to maximize your potential and elevate your career.
          </motion.p>
        </div>

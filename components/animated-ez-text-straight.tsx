...
interface AnimatedEZTextStraightProps {
  className?: string
}

export default function AnimatedEZTextStraight({ className = "" }: AnimatedEZTextStraightProps) {
  ...
  return (
    <div className={`relative inline-block ${className}`}>
      {/* Highlighter background with straight edges but slight imperfections */}
      <motion.div
        className="absolute inset-0 bg-[#407140]/25 z-0"
        style={{
          clipPath: "polygon(0% 5%, 100% 0%, 98% 95%, 2% 100%)",
      ...
      {/* SVG for drawing animation with straight lines but rough corners */}
      <div className="absolute inset-0 flex items-center justify-center z-10">
        ...
        >
          {/* E letter with straight lines but rough corners */}
          ...
          {/* Z letter with straight lines but rough corners */}

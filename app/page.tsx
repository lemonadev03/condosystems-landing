...
import { ArrowRight, Building2, DollarSign, Home, MapPin, Play, Users } from "lucide-react"
                      ...
                      <div className="bg-gray-50 shadow-md rounded-2xl p-8 hover:shadow-lg transition-shadow border border-gray-100 group">
                        <div className="mb-6">
                          ...
                          <p className="text-gray-600 mb-6">
                            Our innovative commission structure ensures you keep more of what you earn, with splits
                            starting at 80/20 and increasing based on performance.
                          </p>
                        </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-8 items-center">
                      ...
                      <div className="bg-gray-50 shadow-md rounded-2xl p-8 hover:shadow-lg transition-shadow border border-gray-100 group">
                        <div className="mb-6">
                          ...
                          <p className="text-gray-600 mb-6">
                            Never feel alone in your business. Our dedicated support team and community of successful
                            agents are always available to help you overcome challenges.
                          </p>
                        </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-8 items-center">
                      <div className="bg-gray-50 shadow-md rounded-2xl p-8 hover:shadow-lg transition-shadow border border-gray-100 group">
                        <div className="mb-6">
                          ...
                          <p className="text-gray-600 mb-6">
                            Our innovative approach allows you to build a thriving real estate career while maintaining
                        ...
                        <div className="space-y-6">
                          ...
                          <div className="relative bg-white p-4 rounded-lg shadow-sm hover:shadow transition-shadow">
                            ...
                            <div className="pl-4">
                              ...
                              <p className="text-gray-600">
                                State-of-the-art technology allows you to work from anywhere
                              </p>
                            </div>
                          </div>
